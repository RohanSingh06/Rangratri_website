 ...
 text-5xl md:text-6xl lg:text-8xl">
        ...
        <div className="rr-container">
          <div className="grid gap-4 md:grid-cols-2">
            {hasPhone && (
              ...
              >
                <Phone size={22} className="text-[#f4d47a]" />
            ...
            {hasEmail && (
              <a
                ...
                className="rr-card rr-frame group"
              >
                <Mail size={22} className="text-[#f4d47a]" />
            ...
            >
              ...
              <p className="rr-label mt-7">Instagram</p>
            ...
            <div className="rr-card rr-frame">
              <MapPin size={22} className="text-[#f4d47a]" />

              <p className="rr-label mt-7">Event Venue</p>
      ...
      <section className="rr-section bg-[#08030f]">
        <div className="rr-container text-center">
          <p className="rr-label">Sponsorship & Partnerships</p>
